...
import { useAppNavigation, GameCompletionParams } from '../../navigation/types';
      ...
      <ScrollView contentContainerStyle={[styles.scrollContent, isAndroid && styles.scrollContentAndroid]} showsVerticalScrollIndicator={false}>
        <View style={[styles.glassPanel, { backgroundColor: isDark ? 'rgba(20,40,29,0.7)' : (isAndroid ? 'rgba(255,255,255,0.96)' : 'rgba(255,255,255,0.5)'), borderColor: isDark ? 'rgba(100,150,120,0.35)' : 'rgba(255,255,255,0.7)' }]}>
          <View style={styles.trophyWrap}>
            <LinearGradient colors={[colors.primary, '#22c55e']} style={styles.trophyGradient}>
        ...
        <View style={styles.actionStack}>
          <TouchableOpacity
            ...
            onPress={() => navigation.replace('GameArena', { overs })}
          >
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  backgroundEffects: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 },
  stadiumGradient: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 },
  dotPattern: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, borderWidth: 0.5, borderStyle: 'dotted', opacity: 0.15 },
  scrollContent: { paddingHorizontal: 20, paddingTop: 24, paddingBottom: 40, gap: 20 },
  scrollContentAndroid: { paddingTop: 48 },
  glassPanel: {
    borderRadius: 40, padding: 28, borderWidth: 1,
    shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.08, shadowRadius: 30, elevation: 4,
  ...
  trophyGradient: {
    ...
    shadowColor: '#19e62b', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.4, shadowRadius: 18, elevation: 6,
  },
  trophyBadge: {
    position: 'absolute', top: -6, right: 90, width: 30, height: 30, borderRadius: 15,
    alignItems: 'center', justifyContent: 'center',
    shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 4,
  },
  titleBlock: { alignItems: 'center', gap: 6, marginBottom: 20 },
  title: { fontSize: 28, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1 },
  resultLine: { fontSize: 18, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1 },
  scoreCard: { borderRadius: 28, paddingHorizontal: 20, paddingVertical: 16, borderWidth: 1, marginBottom: 20 },
  scoreRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 8 },
  scoreDivider: { height: 1, opacity: 0.6 },
  scoreLabel: { fontSize: 12, fontWeight: '700' },
  scoreValue: { fontSize: 18, fontWeight: '900' },
  avatarRow: { flexDirection: 'row', alignItems: 'center' },
  avatarColumn: { flex: 1, alignItems: 'center', gap: 6 },
  avatarFrame: {
  ...
  avatarLabel: { fontSize: 10, fontWeight: '900', letterSpacing: 2, textTransform: 'uppercase' },
  avatarDivider: { height: 1, flex: 1, marginHorizontal: 10 },
  actionStack: { gap: 14 },
  primaryButton: {
    width: '100%', height: 60, borderRadius: 30, alignItems: 'center', justifyContent: 'center',
    flexDirection: 'row', gap: 10, shadowOpacity: 0.4, shadowRadius: 12, elevation: 6,
  },
  primaryButtonText: { color: '#fff', fontSize: 16, fontWeight: '900', letterSpacing: 1 },
  secondaryButton: {
    width: '100%', height: 60, borderRadius: 30, alignItems: 'center', justifyContent: 'center',
    flexDirection: 'row', gap: 10, borderWidth: 2,
  },
  secondaryButtonText: { fontSize: 16, fontWeight: '900', letterSpacing: 1 },
});