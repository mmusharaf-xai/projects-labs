...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  scrollContent: { padding: 24, paddingBottom: 100, gap: 40 },
  ...
  sectionTitle: { fontSize: 18, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 2 },
  ...
  ruleNumber: {
    ...
    alignItems: 'center', justifyContent: 'center',
    backgroundColor: '#19e62b', marginBottom: 12,
  },
  ruleNumText: { fontSize: 16, fontWeight: '900', color: '#fff' },
  ruleHeading: { fontSize: 18, fontWeight: '700', marginBottom: 8 },
  ruleDesc: { fontSize: 15, lineHeight: 22 },
  proTips: {
    borderRadius: 20, borderWidth: 2, padding: 24,
  ...
  tipsTitle: { fontSize: 18, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1 },
  tipsList: { gap: 20 },
  tipItem: { flexDirection: 'row', gap: 16 },
  tipText: { fontSize: 15, lineHeight: 22, flex: 1 },
  readyButton: {
    height: 62, borderRadius: 999, flexDirection: 'row',
    alignItems: 'center', justifyContent: 'center', gap: 12,
    shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.4, shadowRadius: 20, elevation: 8,
  },
  readyText: { fontSize: 18, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1 },
});