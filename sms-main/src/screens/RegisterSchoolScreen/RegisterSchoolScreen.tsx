...
const RegisterSchoolScreen: React.FC<RegisterSchoolScreenProps> = memo(({ navigation }) => {
  ...
  }, [name, address, ownerName, phone, email]);
  ...
  }, [currentUserId, name, address, ownerName, phone, email, validateForm, navigation]);
  ...
  const handleAddressChange = useCallback((value: string) => setAddress(value), []);
  const handleOwnerNameChange = useCallback((value: string) => setOwnerName(value), []);
...
RegisterSchoolScreen.displayName = 'RegisterSchoolScreen';
